/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare-env.d.ts` (hash: 38f03b4665d81b817f5818fda3a50c37)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	SCHEDULE_ROOMS: DurableObjectNamespace<import("./worker").ScheduleRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ScheduleRoom";
	}
